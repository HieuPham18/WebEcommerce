...
import '../stylesheets/IntroducePage.scss'
            ...
            <div className="col l-12">
                <div className="introduce-company-info">
                    ...
                    <div className="introduction-general">
                        ...
                        <p className="introduction-general-text">
                            ...
                            chỉ đáng tin cậy của người tiêu dùng Việt. Với khẩu hiệu <i>“Nếu những gì chúng tôi
                                không
                                có, nghĩa là bạn không cần”</i> , chúng tôi đã, đang và sẽ tiếp tục nỗ lực đem
                            đến các
                            sản
                            phẩm công nghệ chính hãng đa dạng, phong phú đi kèm mức giá tốt nhất phục vụ nhu cầu
                            của
                            quý khách hàng.
                        </p>
                        <br/>
                        <p className="introduction-general-text">Sau hơn 20 năm phát triển, Hiếu Mobile đã trở
                            ...
                            tại
                            gần 40 tỉnh thành trên cả nước, trong đó bao gồm hai trung tâm bảo hành tại Hà Nội
                            và
                            một trung tâm bảo hành tại thành phố Hồ Chí Minh. Đến với chuỗi cửa hàng của Hoàng
                            Hà
                            Mobile, quý khách có thể hoàn toàn yên tâm về uy tín, chất lượng sản phẩm với mức
                            giá rẻ
                            hơn khoảng 15-20% so với giá bán trên thị trường. Song song với đó, chúng tôi cũng
                            luôn
                            nỗ lực phục vụ đem đến trải nghiệm dịch vụ tốt nhất cho khách hàng. </p><br/>
                    </div>
                    ...
                    <div className="regulation">
                        <h2 className="regulation-heading">
                            Tôn chỉ hoạt động
                        </h2>
                        ...
                        <p className="regulation-text">
                            ...
                            nghiêm túc, trung thực và có trách nhiệm, để mang tới trải nghiệm dịch vụ tốt nhất.
                        </p>
                        <br/>
                        <p className="regulation-text">
                            Đối với đồng nghiệp, chúng tôi đề cao văn hóa học hỏi, đoàn kết, tương trợ lẫn nhau
                            tạo
